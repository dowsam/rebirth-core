 ...
 * Info:summall-core ColorDecorator.java 2012-2-3 11:22:42 l.xue.nong$$
 */
...
public enum ColorDecorator {
	 ...
	 */
	private ColorDecorator(short index) {
		this.index = index;
	}
	 ...
	 */
	public static ColorDecorator instance(short index) {
		for (ColorDecorator e : ColorDecorator.values()) {
			if (e.getIndex() == index) {
				return e;
			}
		}
		return ColorDecorator.AUTOMATIC;
	}
}
